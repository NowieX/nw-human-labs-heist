...
RegisterNetEvent('nw-human-labs:client:CreatePoliceBlip:PoliceBlip')
AddEventHandler('nw-human-labs:client:CreatePoliceBlip:PoliceBlip', function(ElectricBoxCoords)
